...
const float velMax = 0.5f, velMin = 0.01f, velInc = 0.01f;	// Parâmetros de "velocidade" do personagem e dos itens
...
int main() {
	...
	srand(time(0)); // Pega o horário do sistema como semente para a geração de números pseudo aleatórios
