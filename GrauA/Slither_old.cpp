...
// 	Parâmetros para exerc. 6 a,b,c,d	//	Círculo	 |	Octagno	 |	Pentagno  |  PacMan  |  FatiaPizz  | Estrela
	...
	//GLuint VAO = createPoligno(verticesExternos, anguloInicial, anguloFinal);	// retorna o identificador OpenGL para o VAO
	...
	float passo = 1.0;	// incremento na posição x ou y
	...
	while (!glfwWindowShouldClose(window))	{
		...
		//aplicaTransformacoes(shaderID, VAO, posicaoNaTela, 0.0, vec3(100,100,1), vec3(1.0,0.0,0.0));
		//glDrawArrays(GL_TRIANGLES_FAN, 0, verticesExternos + 2);
