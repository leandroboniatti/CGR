...
const float passoKbca = 0.5f;	// "velocidade" de incremento na posição da cabeça
const float passoSegm = 0.5f;	// "velocidade" de incremento na posição dos elementos seguintes
